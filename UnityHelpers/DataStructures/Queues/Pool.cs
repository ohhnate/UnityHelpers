...
public class Pool<T> where T : Component
{
    ...
    /// <param name="maxPoolSize">The maximum pool size for the queue. Defaults to in.MaxValue</param>
    public Pool(T prefab, int maxPoolSize = int.MaxValue)
    {
        _prefab = prefab;
    ...
    public T Get()
    {
        ...
        {
            if (_inactiveInstances.Count >= _maxPoolSize) return null;
